...
import type { CreateWorkerTypeRequest, WorkerCapability } from "../../types";
...
const defaultForm: CreateWorkerTypeRequest = {
  name: "",
  version: "",
...
export default function RegisterWorkerModal({
  ...
  const [form, setForm] = useState<CreateWorkerTypeRequest>(defaultForm);
