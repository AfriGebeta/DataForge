        ...
        <div style={{ padding: 18 }}>
          ...
          <div className="fr">
            <div className="fg">
              ...
              <input type="text" name="source_place_id" placeholder="e.g. 101" value={form.source_place_id} onChange={handleChange} />
            </div>
            <div className="fg">
              <label className="fl">Target place ID</label>
              <input type="text" name="target_place_id" placeholder="e.g. 102 (optional)" value={form.target_place_id ?? ""} onChange={handleChange} />
            </div>
          </div>
          ...
          <div className="fg">
            <label className="fl">Source type <span>*</span></label>
